        ...
        <a-row :gutter="24">
          <a-col :lg="6" :md="12" :sm="24" :xs="24">
            <a-form-item label="姓名">
              <a-input :value(v-model)="formState.name">
              </a-input>
            </a-form-item>
          </a-col>
          <a-col :lg="6" :md="12" :sm="24" :xs="24">
            <a-form-item label="性别">
              <a-input :value(v-model)="formState.gender">
              </a-input>
            </a-form-item>
          </a-col>
          <a-col :lg="6" :md="12" :sm="24" :xs="24">
            <a-form-item label="手机号">
              <a-input :value(v-model)="formState.mobile">
              </a-input>
            </a-form-item>
          </a-col>
        ...
        <a-row :gutter="24">
          <a-col :lg="6" :md="12" :sm="24" :xs="24">
            <a-form-item v-if="expand" label="年龄">
              <a-input :value(v-model)="formState.birthday">
              </a-input>
            </a-form-item>
          </a-col>
        </a-row>
        ...
        <div class="new-table-tool">
          ...
          <div>
            <a-space align="center">
              边框
              <a-switch
                v-model:checked="isBordered"
                @click="handleSwitch('isBordered')"
              />
              <a-divider type="vertical"></a-divider>
              斑马线
              <a-switch
                v-model:checked="isZebra"
                @click="handleSwitch('isZebra')"
              />
              <a-divider type="vertical"></a-divider>
              高度铺满
              <a-switch
                v-model:checked="isBoundless"
                @click="handleSwitch('isBoundless')"
              />
            </a-space>

          </div>
        </div>
        <a-table :bordered="bordered" :class="classObj" :columns="columns" :data-source="list"
                 :loading="loading"
                 :row-class-name="
        zebra
